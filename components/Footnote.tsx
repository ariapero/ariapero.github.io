...
export default function Footnote() {
    ...
    if (pathname === '/bio' || pathname === '/work/design' || pathname === '/work/photo' || pathname === '/work/instrumental' || pathname === '/work/textile' || pathname === '/work/composition' || pathname === '/work/video' || pathname === '/work/poetry') return null
